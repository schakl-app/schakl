...
Thin by design. The queries live in :mod:`~app.integrations.google_ads.reporting`, the transport in
...
from app.integrations.google_ads.decisions import GoogleAdsDecisionService
from app.integrations.google_ads.models import GoogleAdsAccount
from app.integrations.google_ads.reporting import ReadResult, Slice, Window
from app.integrations.google_ads.schemas import (
