...
from app.integrations.google_ads.router import router
...
module = ModuleDescriptor(
    ...
    # and reads well beside the dashboard, but it is its own screen with its own answer, and a
    # tenant who bought advertising reporting and nothing else must not be made to switch on a
    # module they did not want.
    requires=("google",),
    router=router,
