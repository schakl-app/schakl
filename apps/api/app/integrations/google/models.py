...
class GoogleConnection(UUIDPrimaryKeyMixin, OrgScopedMixin, TimestampMixin, Base):
    ...
    Raw tokens never leave :mod:`app.integrations.google.client` — every caller asks the factory
    ...
    #: which the cron writes too: see :mod:`app.integrations.google.gmail.refresh`.
