...
So the chain is a function that decides (:func:`~app.integrations.google.gmail.service.classify`)
...
The two exceptions are in :class:`~app.integrations.google.gmail.models.GmailSkip`, and the test for
