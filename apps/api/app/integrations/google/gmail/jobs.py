...
from app.integrations.google.gmail.service import fetch_body, poll_connection, reap_skips
...
async def google_gmail_reap_skips(ctx: dict) -> None:  # noqa: ARG001
    ...
    :mod:`~app.integrations.google.gmail.gates` argues against. The window (``SKIP_RETENTION_DAYS``)
