...
WORDPRESS_PERMISSIONS: list[PermissionSpec] = [
    ...
    # Trashing or deleting a record through the schakl WordPress MCP Bridge. Its own key rather
    # than a refinement of `write`, for the trash module's reason: the person who may draft a page
