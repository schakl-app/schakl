...
Four keys. Reading is team-wide (a meeting's minutes are the record of what was agreed with a
...
the admin's, exactly as deleting a contact moment is; and the org-wide settings (the consent
statement, the minutes document, the house writing instructions) are the admin's too.
...
MEETING_PERMISSIONS: list[PermissionSpec] = [
    ...
    PermissionSpec("meetings.settings.manage", position=40),
]
