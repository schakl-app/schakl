...
# Client-portal management moved out to its own module (#193): ``/api/v1/portal/logins/
# contact/{id}``. Contacts keeps only the subject provider it registers on the core seam.
