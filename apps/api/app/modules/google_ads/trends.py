...
That is the whole reason :class:`~app.modules.google_ads.models.GoogleAdsMetricDaily` exists. A
...
from app.modules.google_ads.models import GoogleAdsDimension, GoogleAdsMetricDaily
from app.modules.google_ads.reporting import totals_from_rows
