...
<div class="mb-2 flex flex-wrap items-center justify-end gap-2">
  <!-- What the board is grouped by (#395). Real links, because the grouping is in the URL and
       ...
       and the back button undoes a switch. It sits at the left of the toolbar rather than among
       the filter chips above, because it changes how the same rows *read* and not which rows
       there are — the same reason Kolommen lives here. -->
  <div
    class="mr-auto flex items-center gap-1 text-xs"
    role="group"
