<script lang="ts">
  ...
  import PortalCard from "$lib/modules/portal/PortalCard.svelte";
...
{:else}
  <div class="grid gap-4">
    ...
    {#if data.portal}
      <!-- Client portal (#193): drawn by the portal module, which owns its permission, its
           entitlement and its locked state. -->
      <PortalCard data={data.portal} subjectName={fullName} {form} />
    {/if}
  </div>
{/if}
