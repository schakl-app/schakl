  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        {
          // Generated by scripts/site-api-reference.mjs from the API's own OpenAPI document —
          // collapsed, because it is a reference to look things up in rather than a chapter to
          // read, and it is the longest group in the sidebar by an order of magnitude.
          label: 'API-referentie',
