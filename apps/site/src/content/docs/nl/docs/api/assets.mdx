...
128 endpoints, verdeeld over 7 groepen. Een recht geschreven als `module.resource.action:own` heeft een bereik: `:own` dekt rijen die van jou zijn, `:any` die van iedereen, en `:any` voldoet aan een controle op `:own`.
...
Antwoord: `200` · `DomainTotalsReport`
...
Recht: `wordpress.ability.read`

Padparameters: `site_id`

Antwoord: `200` · `WordPressAbility[]`
...
Antwoord: `200` · `WordPressAbilityResult`
...
Antwoord: `200` · `WordPressBridgeInfo`
...
Recht: `wordpress.content.read`

Padparameters: `site_id`

Antwoord: `200` · `WordPressLanguages`
...
Recht: `wordpress.content.write`

Padparameters: `site_id`

Request body: `WordPressMediaUpload`

Antwoord: `201` · `WordPressBridgeMedia`
...
Antwoord: `200` · `WordPressMenuList`
...
Padparameters: `site_id`, `menu`

Antwoord: `200` · `WordPressMenu`
...
Recht: `wordpress.content.publish`

Padparameters: `site_id`, `menu`

Request body: `WordPressMenuItemAdd`

Antwoord: `201` · `WordPressMenu`
...
Padparameters: `site_id`, `menu`, `item_id`
...
Antwoord: `200` · `WordPressOptionsPages`
...
Antwoord: `200` · `WordPressOptionsRead`
...
Antwoord: `200` · `WordPressRecordList`
...
Recht: `wordpress.content.delete`
...
Antwoord: `200` · `WordPressBridgeDelete`
...
Antwoord: `200` · `WordPressTranslations`
...
Antwoord: `200` · `WordPressBridgeSchema`
...
Antwoord: `200` · `WordPressStringList`
...
Antwoord: `200` · `WordPressStringResult`
...
| Naam | Type | Betekenis |
| --- | --- | --- |
| `taxonomy` | string · verplicht |  |
| `search` | string |  |
| `lang` | string |  |
| `mode` | string |  (default `none`) |

Antwoord: `200` · `WordPressBridgeTermList`
...
Antwoord: `201` · `WordPressBridgeTerm`
...
Antwoord: `200` · `WordPressContentList`
...
Antwoord: `201` · `WordPressContentRead`
...
Padparameters: `site_id`, `type`, `wp_id`

Antwoord: `200` · `WordPressContentRead`
...
Antwoord: `200` · `WordPressFormRow[]`

#### `POST /api/v1/wordpress/sites/{site_id}/forms`

**Create Site Form**

Recht: `wordpress.forms.write`

Padparameters: `site_id`

Request body: `WordPressFormCreate`

Antwoord: `201` · `WordPressFormRead`
...
Antwoord: `200` · `WordPressFormRead`
...
Antwoord: `200` · `WordPressMediaList`
...
Antwoord: `200` · `WordPressMediaRow`
...
Recht: `wordpress.rest.read`

Padparameters: `site_id`

Request body: `WordPressRestCall`

Antwoord: `200` · `WordPressRestResult`
...
Antwoord: `200` · `WordPressSiteSummary`
