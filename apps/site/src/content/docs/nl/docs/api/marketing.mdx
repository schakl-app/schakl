...
| --- | --- | --- |
| `GET` `/marketing/accounts` | Available Accounts | `marketing.link.manage` |
| `GET` `/marketing/clients` | Linked Clients | `marketing.metrics.read` |
| `GET` `/marketing/companies/{company_id}/drilldown` | Drilldown | `marketing.metrics.read` |
| `GET` `/marketing/companies/{company_id}/metrics` | Company Metrics | `marketing.metrics.read` |
| `GET` `/marketing/companies/{company_id}/settings` | Get Company Settings | `marketing.metrics.read` |
| `PUT` `/marketing/companies/{company_id}/settings` | Set Company Settings | `marketing.link.manage` |
| `GET` `/marketing/links` | List Links | `marketing.metrics.read` |
| `POST` `/marketing/links` | Create Link | `marketing.link.manage` |
| `DELETE` `/marketing/links/{link_id}` | Unlink | `marketing.link.manage` |
| `GET` `/marketing/overview` | Overview | `marketing.overview.read` |
| `GET` `/marketing/settings` | Get Settings | `marketing.link.manage` |
| `PUT` `/marketing/settings` | Save Settings | `marketing.link.manage` |
| `GET` `/marketing/summary` | Summary | `marketing.metrics.read` |
...
| Endpoint | Wat het doet | Recht |
| --- | --- | --- |
| `GET` `/google-ads/accounts` | List Google Ads Accounts | `google_ads.account.read` |
| `POST` `/google-ads/accounts` | Link Google Ads Account | `google_ads.settings.manage` |
| `GET` `/google-ads/accounts/{account_id}` | Get Google Ads Account | `google_ads.account.read` |
| `PATCH` `/google-ads/accounts/{account_id}` | Update Google Ads Account | `google_ads.settings.manage` |
| `DELETE` `/google-ads/accounts/{account_id}` | Unlink Google Ads Account | `google_ads.settings.manage` |
| `GET` `/google-ads/accounts/{account_id}/ad-groups` | Google Ads Ad Groups | `google_ads.account.read` |
| `POST` `/google-ads/accounts/{account_id}/ad-groups` | Create Google Ads Ad Group | `google_ads.campaign.write` |
| `PATCH` `/google-ads/accounts/{account_id}/ad-groups/{ad_group_id}` | Update Google Ads Ad Group | `google_ads.campaign.write` |
| `DELETE` `/google-ads/accounts/{account_id}/ad-groups/{ad_group_id}` | Remove Google Ads Ad Group | `google_ads.campaign.write` |
| `DELETE` `/google-ads/accounts/{account_id}/ad-groups/{ad_group_id}/ads/{ad_id}` | Remove Google Ads Ad | `google_ads.campaign.write` |
| `GET` `/google-ads/accounts/{account_id}/ads` | Google Ads Ads | `google_ads.account.read` |
| `POST` `/google-ads/accounts/{account_id}/ads` | Create Google Ads Ad | `google_ads.campaign.write` |
| `PATCH` `/google-ads/accounts/{account_id}/ads` | Update Google Ads Ad | `google_ads.campaign.write` |
| `POST` `/google-ads/accounts/{account_id}/budgets` | Create Google Ads Budget | `google_ads.budget.write` |
| `PATCH` `/google-ads/accounts/{account_id}/budgets/{budget_id}` | Update Google Ads Budget | `google_ads.budget.write` |
| `DELETE` `/google-ads/accounts/{account_id}/budgets/{budget_id}` | Remove Google Ads Budget | `google_ads.budget.write` |
| `GET` `/google-ads/accounts/{account_id}/campaigns` | Google Ads Campaigns | `google_ads.account.read` |
| `POST` `/google-ads/accounts/{account_id}/campaigns` | Create Google Ads Campaign | `google_ads.campaign.write` |
| `PATCH` `/google-ads/accounts/{account_id}/campaigns/{campaign_id}` | Update Google Ads Campaign | `google_ads.campaign.write` |
| `DELETE` `/google-ads/accounts/{account_id}/campaigns/{campaign_id}` | Remove Google Ads Campaign | `google_ads.campaign.write` |
| `GET` `/google-ads/accounts/{account_id}/changes` | Google Ads Changes | `google_ads.account.read` |
| `GET` `/google-ads/accounts/{account_id}/conversions` | Google Ads Conversion Health | `google_ads.account.read` |
| `GET` `/google-ads/accounts/{account_id}/decisions` | List Google Ads Decisions | `google_ads.account.read` |
| `POST` `/google-ads/accounts/{account_id}/decisions` | Record Google Ads Decision | `google_ads.policy.manage` |
| `DELETE` `/google-ads/accounts/{account_id}/decisions/{decision_id}` | Withdraw Google Ads Decision | `google_ads.policy.manage` |
| `GET` `/google-ads/accounts/{account_id}/devices` | Google Ads Devices | `google_ads.account.read` |
| `GET` `/google-ads/accounts/{account_id}/geo` | Google Ads Geo | `google_ads.account.read` |
| `POST` `/google-ads/accounts/{account_id}/keyword-ideas` | Google Ads Keyword Ideas | `google_ads.account.read` |
| `GET` `/google-ads/accounts/{account_id}/keywords` | Google Ads Keywords | `google_ads.account.read` |
| `POST` `/google-ads/accounts/{account_id}/keywords` | Add Google Ads Keywords | `google_ads.keyword.write` |
| `PATCH` `/google-ads/accounts/{account_id}/keywords` | Update Google Ads Keyword | `google_ads.keyword.write` |
| `POST` `/google-ads/accounts/{account_id}/keywords/remove` | Remove Google Ads Keywords | `google_ads.keyword.write` |
| `POST` `/google-ads/accounts/{account_id}/negative-lists` | Create Google Ads Negative List | `google_ads.negative.write` |
| `DELETE` `/google-ads/accounts/{account_id}/negative-lists/{shared_set_id}` | Remove Google Ads Negative List | `google_ads.negative.write` |
| `GET` `/google-ads/accounts/{account_id}/negatives` | Google Ads Negatives | `google_ads.account.read` |
| `POST` `/google-ads/accounts/{account_id}/negatives` | Add Google Ads Negatives | `google_ads.negative.write` |
| `POST` `/google-ads/accounts/{account_id}/negatives/remove` | Remove Google Ads Negatives | `google_ads.negative.write` |
| `GET` `/google-ads/accounts/{account_id}/policy` | Get Google Ads Policy | `google_ads.policy.manage` |
| `PUT` `/google-ads/accounts/{account_id}/policy` | Save Google Ads Policy | `google_ads.policy.manage` |
| `DELETE` `/google-ads/accounts/{account_id}/policy` | Clear Google Ads Policy | `google_ads.policy.manage` |
| `POST` `/google-ads/accounts/{account_id}/query` | Google Ads Query | `google_ads.query.run` |
| `GET` `/google-ads/accounts/{account_id}/recommendations` | Google Ads Recommendations | `google_ads.account.read` |
| `GET` `/google-ads/accounts/{account_id}/search-terms` | Google Ads Search Terms | `google_ads.account.read` |
| `GET` `/google-ads/accounts/{account_id}/snapshot` | Google Ads Snapshot | `google_ads.account.read` |
| `GET` `/google-ads/accounts/{account_id}/trend` | Google Ads Trend | `google_ads.account.read` |
| `POST` `/google-ads/accounts/{account_id}/verify` | Verify Google Ads Account | `google_ads.settings.manage` |
| `GET` `/google-ads/accounts/available` | List Available Google Ads Accounts | `google_ads.settings.manage` |
| `GET` `/google-ads/policy` | Get Google Ads House Policy | `google_ads.policy.manage` |
| `PUT` `/google-ads/policy` | Save Google Ads House Policy | `google_ads.policy.manage` |
| `DELETE` `/google-ads/policy` | Clear Google Ads House Policy | `google_ads.policy.manage` |
| `GET` `/google-ads/settings` | Get Google Ads Settings | `google_ads.settings.manage` |
| `PUT` `/google-ads/settings` | Save Google Ads Settings | `google_ads.settings.manage` |
...
| Endpoint | Wat het doet | Recht |
| --- | --- | --- |
| `GET` `/gtm/containers` | List Gtm Containers | `google_tag_manager.container.read` |
| `POST` `/gtm/containers` | Link Gtm Container | `google_tag_manager.settings.manage` |
| `GET` `/gtm/containers/{container_id}` | Get Gtm Container | `google_tag_manager.container.read` |
| `PATCH` `/gtm/containers/{container_id}` | Update Gtm Container | `google_tag_manager.settings.manage` |
| `DELETE` `/gtm/containers/{container_id}` | Unlink Gtm Container | `google_tag_manager.settings.manage` |
| `GET` `/gtm/containers/{container_id}/conversions` | List Gtm Conversions | `google_tag_manager.container.read` |
| `POST` `/gtm/containers/{container_id}/conversions` | Create Gtm Conversion | `google_tag_manager.tag.write` |
| `GET` `/gtm/containers/{container_id}/snippet` | Gtm Container Snippet | `google_tag_manager.container.read` |
| `GET` `/gtm/containers/{container_id}/status` | Gtm Workspace Status | `google_tag_manager.container.read` |
| `GET` `/gtm/containers/{container_id}/tags` | List Gtm Tags | `google_tag_manager.container.read` |
| `POST` `/gtm/containers/{container_id}/tags` | Create Gtm Tag | `google_tag_manager.tag.write` |
| `PATCH` `/gtm/containers/{container_id}/tags/{tag_id}` | Update Gtm Tag | `google_tag_manager.tag.write` |
| `DELETE` `/gtm/containers/{container_id}/tags/{tag_id}` | Delete Gtm Tag | `google_tag_manager.tag.write` |
| `GET` `/gtm/containers/{container_id}/triggers` | List Gtm Triggers | `google_tag_manager.container.read` |
| `POST` `/gtm/containers/{container_id}/triggers` | Create Gtm Trigger | `google_tag_manager.tag.write` |
| `DELETE` `/gtm/containers/{container_id}/triggers/{trigger_id}` | Delete Gtm Trigger | `google_tag_manager.tag.write` |
| `GET` `/gtm/containers/{container_id}/variables` | List Gtm Variables | `google_tag_manager.container.read` |
| `POST` `/gtm/containers/{container_id}/variables` | Create Gtm Variable | `google_tag_manager.tag.write` |
| `DELETE` `/gtm/containers/{container_id}/variables/{variable_id}` | Delete Gtm Variable | `google_tag_manager.tag.write` |
| `POST` `/gtm/containers/{container_id}/verify` | Verify Gtm Container | `google_tag_manager.settings.manage` |
| `GET` `/gtm/containers/{container_id}/versions` | List Gtm Versions | `google_tag_manager.container.read` |
| `POST` `/gtm/containers/{container_id}/versions` | Create Gtm Version | `google_tag_manager.tag.write` |
| `POST` `/gtm/containers/{container_id}/versions/{version_id}/publish` | Publish Gtm Version | `google_tag_manager.version.publish` |
| `GET` `/gtm/containers/{container_id}/workspaces` | List Gtm Workspaces | `google_tag_manager.container.read` |
| `GET` `/gtm/containers/available` | List Available Gtm Containers | `google_tag_manager.settings.manage` |
| `GET` `/gtm/settings` | Get Gtm Settings | `google_tag_manager.settings.manage` |
| `PUT` `/gtm/settings` | Save Gtm Settings | `google_tag_manager.settings.manage` |
...
| Endpoint | Wat het doet | Recht |
| --- | --- | --- |
| `GET` `/reporting/companies/{company_id}/profile` | Get Profile | `reporting.profile.manage` |
| `PUT` `/reporting/companies/{company_id}/profile` | Save Profile | `reporting.profile.manage` |
| `GET` `/reporting/reports` | List Reports | `reporting.report.read` |
| `GET` `/reporting/reports/{report_id}` | Get Report | `reporting.report.read` |
| `DELETE` `/reporting/reports/{report_id}` | Delete Report | `reporting.report.write` |
| `PUT` `/reporting/reports/{report_id}/narrative` | Edit Narrative | `reporting.report.write` |
| `GET` `/reporting/reports/{report_id}/pdf` | Report Pdf | `reporting.report.read` |
| `GET` `/reporting/reports/{report_id}/preview` | Preview Report | `reporting.report.read` |
| `POST` `/reporting/reports/{report_id}/publish` | Publish Report | `reporting.report.send` |
| `POST` `/reporting/reports/{report_id}/rewrite` | Rewrite Section | `reporting.report.write` |
| `POST` `/reporting/reports/{report_id}/send` | Send Report | `reporting.report.send` |
| `POST` `/reporting/reports/generate` | Generate Report | `reporting.report.write` |
| `POST` `/reporting/reports/generate-batch` | Generate Batch | `reporting.report.write` |
| `GET` `/reporting/settings` | Get Settings | `reporting.profile.manage` |
| `PUT` `/reporting/settings` | Save Settings | `reporting.settings.manage` |
| `GET` `/reporting/templates` | List Templates | `reporting.profile.manage` |
| `POST` `/reporting/templates` | Create Template | `reporting.settings.manage` |
| `PUT` `/reporting/templates/{template_id}` | Update Template | `reporting.settings.manage` |
| `DELETE` `/reporting/templates/{template_id}` | Delete Template | `reporting.settings.manage` |
| `GET` `/reporting/templates/designs/{design}/source` | Template Source | `reporting.settings.manage` |
| `POST` `/reporting/templates/preview` | Preview Template | `reporting.settings.manage` |
| `GET` `/reporting/templates/sections` | Section Catalog | `reporting.settings.manage` |
| `GET` `/reporting/tones` | List Tones | `reporting.profile.manage` |
| `POST` `/reporting/tones` | Create Tone | `reporting.settings.manage` |
| `PUT` `/reporting/tones/{tone_id}` | Update Tone | `reporting.settings.manage` |
| `DELETE` `/reporting/tones/{tone_id}` | Delete Tone | `reporting.settings.manage` |
