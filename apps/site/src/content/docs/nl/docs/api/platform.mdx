...
279 endpoints, verdeeld over 20 groepen. Een recht geschreven als `module.resource.action:own` heeft een bereik: `:own` dekt rijen die van jou zijn, `:any` die van iedereen, en `:any` voldoet aan een controle op `:own`.
...
Antwoord: `200` · `CustomFieldScopeRead[]`
...
Recht: `google_search_console.site.read`

Queryparameters:

| Naam | Type | Betekenis |
| --- | --- | --- |
| `site` | string · verplicht | The property exactly as GET /sites lists it: sc-domain:klant.nl for a domain property or https://www.klant.nl/ (trailing slash included) for a URL-prefix property. A bare hostname is read as the domain property. |
...
Antwoord: `200` · `GoogleSearchConsoleAiVisibility`
...
Antwoord: `200` · `GoogleSearchConsoleReport`
...
| --- | --- | --- |
| `site` | string · verplicht | The property exactly as GET /sites lists it: sc-domain:klant.nl for a domain property or https://www.klant.nl/ (trailing slash included) for a URL-prefix property. A bare hostname is read as the domain property. |
| `url` | string · verplicht | The page to inspect. Must be under the property. |
| `language` | string | BCP-47 code for the issue texts, e.g. nl. |

Antwoord: `200` · `GoogleSearchConsoleInspection`
...
Antwoord: `200` · `GoogleSearchConsoleMovers`
...
Antwoord: `200` · `GoogleSearchConsoleOverview`
...
Recht: `google_search_console.report.run`
...
Antwoord: `200` · `GoogleSearchConsoleSearchTypes`
...
Antwoord: `200` · `GoogleSearchConsoleSite`
...
| --- | --- | --- |
| `site` | string · verplicht | The property exactly as GET /sites lists it: sc-domain:klant.nl for a domain property or https://www.klant.nl/ (trailing slash included) for a URL-prefix property. A bare hostname is read as the domain property. |
| `feedpath` | string · verplicht | The sitemap's own URL, as /sitemaps lists it. |

Antwoord: `200` · `GoogleSearchConsoleSitemap`
...
Antwoord: `200` · `GoogleSearchConsoleSitemapList`
...
Antwoord: `200` · `GoogleSearchConsoleSiteList`
...
Recht: `impex.export`, `invoicing.invoice.read`
...
Recht: `impex.import`, `invoicing.invoice.write`
...
Padparameters: `meeting_id`

Antwoord: `200` · `MeetingDetail`
...
Antwoord: `200` · `MeetingReviseResult`
...
Antwoord: `200` · `MeetingConfirmResult`
...
Antwoord: `200` · `MeetingStatusRead`
...
Recht: `meetings.settings.manage`

Antwoord: `200` · `MeetingSettingsRead`
...
Antwoord: `200` · `MeetingDesignSource`
...
Antwoord: `200` · `MeetingSectionCatalogEntry[]`
...
| `POST` `/microsoft/calendar/webhook` | _Bewust open_ |
...
Recht: `microsoft.connection.manage`

Antwoord: `200` · `MicrosoftCalendarListEntry[]`
...
Recht: `microsoft.calendar.read`

Antwoord: `200` · `MicrosoftSelectedCalendar[]`
...
Antwoord: `200` · `MicrosoftCalendarFeedItem[]`
...
Recht: `microsoft.settings.manage`

Antwoord: `200` · `MicrosoftConnectionRead[]`
...
Antwoord: `200` · `MyMicrosoftConnectionRead`
...
Antwoord: `200` · `OneDriveBrowseResult`
...
Recht: `microsoft.onedrive.write`

Padparameters: `drive_id`, `item_id`
...
Antwoord: `200` · `OneDriveBulkProvisionResult`
...
Antwoord: `200` · `OneDriveStateRead`
...
Antwoord: `200` · `OneDriveUploadSession`
...
Antwoord: `201` · `OutlookImportResult`
...
| Naam | Type | Betekenis |
| --- | --- | --- |
| `reference` | string · verplicht | An Outlook on the web link, a Graph message id, or an RFC-822 Message-ID |

Antwoord: `200` · `OutlookLookupResult`
...
Antwoord: `200` · `OutlookRefreshResult`
...
Antwoord: `200` · `OutlookSearchResult`
...
Antwoord: `200` · `OutlookSyncStatus`
...
Antwoord: `200` · `MicrosoftSettingsRead`
...
Padparameters: `entity_id`

Antwoord: `200` · `TrashItem`
