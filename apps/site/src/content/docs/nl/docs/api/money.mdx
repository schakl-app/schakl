...
| `POST` `/invoicing/payments/webhook/{provider}/{token}` | Payment Webhook | _Bewust open_ |
...
| `GET` `/invoicing/public/invoices/{token}` | Public Invoice | _Bewust open_ |
| `POST` `/invoicing/public/invoices/{token}/payment-intents` | Public Start Payment | _Bewust open_ |
| `GET` `/invoicing/public/invoices/{token}/pdf` | Public Invoice Pdf | _Bewust open_ |
| `GET` `/invoicing/public/invoices/{token}/preview` | Public Invoice Preview | _Bewust open_ |
| `POST` `/invoicing/public/invoices/{token}/refresh` | Public Refresh Payments | _Bewust open_ |
...
| `POST` `/snelstart/coupling/callback` | Coupling Callback | _Bewust open_ |
