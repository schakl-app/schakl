...
165 endpoints across 14 groups. A permission written `module.resource.action:own` is scoped: `:own` covers rows that are yours, `:any` covers everyone's, and `:any` satisfies a check for `:own`.
...
| Endpoint | What it does | Permission |
| --- | --- | --- |
| `GET` `/files` | List Files | _Deliberately open_ |
| `POST` `/files` | Upload File | `files.file.write` |
| `GET` `/files/{file_id}` | Serve File | _Deliberately open_ |
| `DELETE` `/files/{file_id}` | Delete File | `files.file.write` |
| `GET` `/files/{file_id}/public` | Serve Public File | _Deliberately open_ |
...
| `GET` `/impex/entities` | List Impex Entities | _Deliberately open_ |
...
| Endpoint | What it does | Permission |
| --- | --- | --- |
| `GET` `/meta/domain-probe` | Domain Probe | _Deliberately open_ |
| `GET` `/meta/instance` | Deployment Meta | _Deliberately open_ |
| `GET` `/meta/mcp` | Mcp Meta | _Deliberately open_ |
| `GET` `/meta/me` | Me | _Deliberately open_ |
| `PATCH` `/meta/me` | Update Me | _Deliberately open_ |
| `GET` `/meta/modules` | Modules | _Deliberately open_ |
| `GET` `/meta/tenant` | Tenant Branding | _Deliberately open_ |
...
| `GET` `/health` | Health | _None declared_ |
| `GET` `/health/ready` | Health Ready | _None declared_ |
...
| Name | Type | Meaning |
| --- | --- | --- |
| `entity_type` | `task` · `project` · `company` · `leave_request` · `timesheet` · required |  |
| `entity_id` | string · required |  |
...
| Endpoint | What it does | Permission |
| --- | --- | --- |
| `GET` `/prefs` | Get Prefs | _Deliberately open_ |
| `PUT` `/prefs` | Set Prefs | _Deliberately open_ |
